...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { low_io[6] }]; #IO_L19P_T3_34 Sch=ck_io[6]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { low_io[7] }]; #IO_L9N_T1_DQS_34 Sch=ck_io[7]
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { high_io[32] }]; #IO_L15P_T2_DQS_13 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { high_io[33] }]; #IO_L21N_T3_DQS_13 Sch=ck_io[33]
