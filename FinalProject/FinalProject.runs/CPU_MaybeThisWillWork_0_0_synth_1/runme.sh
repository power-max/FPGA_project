...
HD_PWD='C:/FPGALabGroupName/FinalProject/FinalProject.runs/CPU_MaybeThisWillWork_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_MaybeThisWillWork_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_MaybeThisWillWork_0_0.tcl
